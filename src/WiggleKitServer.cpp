...
{
    ClassDB::bind_static_method( "WiggleKitServer", D_METHOD( "get_singleton" ),
                                 &WiggleKitServer::get_singleton );
    ClassDB::bind_method( D_METHOD( "particle_create", "position", "mass", "gravity", "damping" ),
                          &WiggleKitServer::particle_create );
    ClassDB::bind_method( D_METHOD( "particle_free", "id" ), &WiggleKitServer::particle_free );
    ClassDB::bind_method( D_METHOD( "particle_set_position", "id", "position" ),
                          &WiggleKitServer::particle_set_position );
    ClassDB::bind_method( D_METHOD( "particle_get_position", "id" ),
                          &WiggleKitServer::particle_get_position );
    ClassDB::bind_method( D_METHOD( "particle_set_mass", "id", "mass" ),
                          &WiggleKitServer::particle_set_mass );
    ClassDB::bind_method( D_METHOD( "particle_get_mass", "id" ),
                          &WiggleKitServer::particle_get_mass );
    ClassDB::bind_method( D_METHOD( "particle_set_gravity", "id", "gravity" ),
                          &WiggleKitServer::particle_set_gravity );
    ClassDB::bind_method( D_METHOD( "particle_get_gravity", "id" ),
                          &WiggleKitServer::particle_get_gravity );
    ClassDB::bind_method( D_METHOD( "particle_set_damping", "id", "damping" ),
                          &WiggleKitServer::particle_set_damping );
    ClassDB::bind_method( D_METHOD( "particle_get_damping", "id" ),
                          &WiggleKitServer::particle_get_damping );
    ClassDB::bind_method( D_METHOD( "particle_set_velocity", "id", "velocity" ),
                          &WiggleKitServer::particle_set_velocity );
    ClassDB::bind_method( D_METHOD( "particle_get_velocity", "id" ),
                          &WiggleKitServer::particle_get_velocity );
    ClassDB::bind_method(
        D_METHOD( "distance_constraint_create", "particle_a", "particle_b", "compliance" ),
        &WiggleKitServer::distance_constraint_create );
    ClassDB::bind_method( D_METHOD( "distance_constraint_free", "id" ),
                          &WiggleKitServer::distance_constraint_free );
    ClassDB::bind_method( D_METHOD( "distance_constraint_set_compliance", "id", "compliance" ),
                          &WiggleKitServer::distance_constraint_set_compliance );
    ClassDB::bind_method( D_METHOD( "distance_constraint_set_rest_length", "id", "rest_length" ),
                          &WiggleKitServer::distance_constraint_set_rest_length );
    ClassDB::bind_method( D_METHOD( "distance_constraint_get_rest_length", "id" ),
                          &WiggleKitServer::distance_constraint_get_rest_length );
    ClassDB::bind_method( D_METHOD( "tetrahedral_constraint_create", "particle_a", "particle_b",
                                    "particle_c", "particle_d", "compliance" ),
                          &WiggleKitServer::tetrahedral_constraint_create );
    ClassDB::bind_method( D_METHOD( "tetrahedral_constraint_free", "id" ),
                          &WiggleKitServer::tetrahedral_constraint_free );
    ClassDB::bind_method( D_METHOD( "tetrahedral_constraint_set_compliance", "id", "compliance" ),
                          &WiggleKitServer::tetrahedral_constraint_set_compliance );
    ClassDB::bind_method(
        D_METHOD( "plane_collider_create", "position", "normal", "bounciness", "friction" ),
        &WiggleKitServer::plane_collider_create );
    ClassDB::bind_method( D_METHOD( "plane_collider_free", "id" ),
                          &WiggleKitServer::plane_collider_free );
    ClassDB::bind_method( D_METHOD( "plane_collider_set_position", "id", "position" ),
    ...
    ClassDB::bind_method( D_METHOD( "plane_collider_remove_particle", "id", "particle_id" ),
                          &WiggleKitServer::plane_collider_remove_particle );
    ClassDB::bind_method( D_METHOD( "sphere_collider_create", "position", "radius", "bounciness",
                                    "friction", "inside" ),
                          &WiggleKitServer::sphere_collider_create, DEFVAL( false ) );
    ClassDB::bind_method( D_METHOD( "sphere_collider_free", "id" ),
                          &WiggleKitServer::sphere_collider_free );
    ClassDB::bind_method( D_METHOD( "sphere_collider_set_position", "id", "position" ),
    ...
    ClassDB::bind_method( D_METHOD( "sphere_collider_remove_particle", "id", "particle_id" ),
                          &WiggleKitServer::sphere_collider_remove_particle );
    ClassDB::bind_method( D_METHOD( "box_collider_create", "position", "basis", "size",
                                    "bounciness", "friction", "inside" ),
                          &WiggleKitServer::box_collider_create, DEFVAL( false ) );
    ClassDB::bind_method( D_METHOD( "box_collider_free", "id" ),
                          &WiggleKitServer::box_collider_free );
    ClassDB::bind_method( D_METHOD( "box_collider_set_position", "id", "position" ),
                          &WiggleKitServer::box_collider_set_position );
    ClassDB::bind_method( D_METHOD( "box_collider_set_basis", "id", "basis" ),
    ...
    ClassDB::bind_method( D_METHOD( "box_collider_remove_particle", "id", "particle_id" ),
                          &WiggleKitServer::box_collider_remove_particle );
    ClassDB::bind_method(
        D_METHOD( "plane_sdf_create", "position", "normal", "rest_distance", "compliance" ),
        &WiggleKitServer::plane_sdf_create );
    ClassDB::bind_method( D_METHOD( "plane_sdf_free", "id" ), &WiggleKitServer::plane_sdf_free );
    ClassDB::bind_method( D_METHOD( "plane_sdf_set_position", "id", "position" ),
                          &WiggleKitServer::plane_sdf_set_position );
    ClassDB::bind_method( D_METHOD( "plane_sdf_set_normal", "id", "normal" ),
                          &WiggleKitServer::plane_sdf_set_normal );
    ClassDB::bind_method( D_METHOD( "plane_sdf_set_rest_distance", "id", "rest_distance" ),
                          &WiggleKitServer::plane_sdf_set_rest_distance );
    ClassDB::bind_method( D_METHOD( "plane_sdf_set_compliance", "id", "compliance" ),
                          &WiggleKitServer::plane_sdf_set_compliance );
    ClassDB::bind_method( D_METHOD( "plane_sdf_add_particle", "id", "particle_id" ),
                          &WiggleKitServer::plane_sdf_add_particle );
    ClassDB::bind_method( D_METHOD( "plane_sdf_remove_particle", "id", "particle_id" ),
                          &WiggleKitServer::plane_sdf_remove_particle );
    ClassDB::bind_method(
        D_METHOD( "sphere_sdf_create", "position", "radius", "rest_distance", "compliance" ),
        &WiggleKitServer::sphere_sdf_create );
    ClassDB::bind_method( D_METHOD( "sphere_sdf_free", "id" ), &WiggleKitServer::sphere_sdf_free );
    ClassDB::bind_method( D_METHOD( "sphere_sdf_set_position", "id", "position" ),
                          &WiggleKitServer::sphere_sdf_set_position );
    ClassDB::bind_method( D_METHOD( "sphere_sdf_set_radius", "id", "radius" ),
                          &WiggleKitServer::sphere_sdf_set_radius );
    ClassDB::bind_method( D_METHOD( "sphere_sdf_set_rest_distance", "id", "rest_distance" ),
                          &WiggleKitServer::sphere_sdf_set_rest_distance );
    ClassDB::bind_method( D_METHOD( "sphere_sdf_set_compliance", "id", "compliance" ),
                          &WiggleKitServer::sphere_sdf_set_compliance );
    ClassDB::bind_method( D_METHOD( "sphere_sdf_add_particle", "id", "particle_id" ),
                          &WiggleKitServer::sphere_sdf_add_particle );
    ClassDB::bind_method( D_METHOD( "sphere_sdf_remove_particle", "id", "particle_id" ),
                          &WiggleKitServer::sphere_sdf_remove_particle );
    ClassDB::bind_method( D_METHOD( "line_sdf_create", "position_a", "position_b", "rest_distance",
                                    "compliance", "infinite" ),
                          &WiggleKitServer::line_sdf_create, DEFVAL( true ) );
    ClassDB::bind_method( D_METHOD( "line_sdf_free", "id" ), &WiggleKitServer::line_sdf_free );
    ClassDB::bind_method( D_METHOD( "line_sdf_set_position_a", "id", "position_a" ),
                          &WiggleKitServer::line_sdf_set_position_a );
    ClassDB::bind_method( D_METHOD( "line_sdf_set_position_b", "id", "position_b" ),
                          &WiggleKitServer::line_sdf_set_position_b );
    ClassDB::bind_method( D_METHOD( "line_sdf_set_infinite", "id", "infinite" ),
                          &WiggleKitServer::line_sdf_set_infinite );
    ClassDB::bind_method( D_METHOD( "line_sdf_set_rest_distance", "id", "rest_distance" ),
                          &WiggleKitServer::line_sdf_set_rest_distance );
    ClassDB::bind_method( D_METHOD( "line_sdf_set_compliance", "id", "compliance" ),
                          &WiggleKitServer::line_sdf_set_compliance );
    ClassDB::bind_method( D_METHOD( "line_sdf_add_particle", "id", "particle_id" ),
                          &WiggleKitServer::line_sdf_add_particle );
    ClassDB::bind_method( D_METHOD( "line_sdf_remove_particle", "id", "particle_id" ),
                          &WiggleKitServer::line_sdf_remove_particle );
    ClassDB::bind_method(
        D_METHOD( "box_sdf_create", "position", "basis", "size", "rest_distance", "compliance" ),
        &WiggleKitServer::box_sdf_create );
    ClassDB::bind_method( D_METHOD( "box_sdf_free", "id" ), &WiggleKitServer::box_sdf_free );
    ClassDB::bind_method( D_METHOD( "box_sdf_set_position", "id", "position" ),
                          &WiggleKitServer::box_sdf_set_position );
    ClassDB::bind_method( D_METHOD( "box_sdf_set_basis", "id", "basis" ),
                          &WiggleKitServer::box_sdf_set_basis );
    ClassDB::bind_method( D_METHOD( "box_sdf_set_size", "id", "size" ),
                          &WiggleKitServer::box_sdf_set_size );
    ClassDB::bind_method( D_METHOD( "box_sdf_set_rest_distance", "id", "rest_distance" ),
                          &WiggleKitServer::box_sdf_set_rest_distance );
    ClassDB::bind_method( D_METHOD( "box_sdf_set_compliance", "id", "compliance" ),
                          &WiggleKitServer::box_sdf_set_compliance );
    ClassDB::bind_method( D_METHOD( "box_sdf_add_particle", "id", "particle_id" ),
                          &WiggleKitServer::box_sdf_add_particle );
    ClassDB::bind_method( D_METHOD( "box_sdf_remove_particle", "id", "particle_id" ),
                          &WiggleKitServer::box_sdf_remove_particle );
    ...
    ClassDB::bind_method( D_METHOD( "warmup", "iterations", "particle_ids" ),
                          &WiggleKitServer::warmup );
}

uint32_t WiggleKitServer::particle_create( const Vector3 &p_position, float p_mass,
                                           const Vector3 &p_gravity, float p_damping )
{
    uint32_t index;
...
uint32_t WiggleKitServer::distance_constraint_create( uint32_t p_particle_a, uint32_t p_particle_b,
                                                      float p_compliance )
{
    ...
    c.rest_length =
        particles[p_particle_a].position.distance_to( particles[p_particle_b].position );
...
uint32_t WiggleKitServer::tetrahedral_constraint_create( uint32_t p_particle_a,
                                                         uint32_t p_particle_b,
                                                         uint32_t p_particle_c,
                                                         uint32_t p_particle_d, float p_compliance )
{
    ERR_FAIL_UNSIGNED_INDEX_V( p_particle_a, particles.size(), INVALID_ID );
    ERR_FAIL_COND_V( !particles[p_particle_a].active, INVALID_ID );
    ERR_FAIL_UNSIGNED_INDEX_V( p_particle_b, particles.size(), INVALID_ID );
...
uint32_t WiggleKitServer::plane_collider_create( const Vector3 &p_position, const Vector3 &p_normal,
...
uint32_t WiggleKitServer::sphere_collider_create( const Vector3 &p_position, float p_radius,
                                                  float p_bounciness, float p_friction,
                                                  bool p_inside )
{
    uint32_t index;
...
uint32_t WiggleKitServer::box_collider_create( const Vector3 &p_position, const Basis &p_basis,
                                               const Vector3 &p_size, float p_bounciness,
                                               float p_friction, bool p_inside )
{
    uint32_t index;
...
uint32_t WiggleKitServer::plane_sdf_create( const Vector3 &p_position, const Vector3 &p_normal,
...
uint32_t WiggleKitServer::sphere_sdf_create( const Vector3 &p_position, float p_radius,
                                             float p_rest_distance, float p_compliance )
{
    uint32_t index;
...
uint32_t WiggleKitServer::line_sdf_create( const Vector3 &p_position_a, const Vector3 &p_position_b,
                                           float p_rest_distance, float p_compliance,
                                           bool p_infinite )
{
    uint32_t index;
...
uint32_t WiggleKitServer::box_sdf_create( const Vector3 &p_position, const Basis &p_basis,
                                          const Vector3 &p_size, float p_rest_distance,
                                          float p_compliance )
{
    uint32_t index;
...
void WiggleKitServer::warmup( int p_iterations, const PackedInt32Array &p_particle_ids )
{
    ...
    for ( uint32_t i = 0; i < distance_constraints.size(); i++ )
    {
        if ( distance_constraints[i].active )
        {
            ...
            bool involved = false;
            if ( pa != INVALID_ID && pa < particles.size() && is_warmup_particle[pa] )
            {
                involved = true;
            }
            if ( pb != INVALID_ID && pb < particles.size() && is_warmup_particle[pb] )
            {
                involved = true;
            }
            if ( !involved )
    ...
    for ( uint32_t i = 0; i < plane_colliders.size(); i++ )
    {
        filter_collider( plane_colliders[i] );
    }
    for ( uint32_t i = 0; i < sphere_colliders.size(); i++ )
    {
        filter_collider( sphere_colliders[i] );
    }
    for ( uint32_t i = 0; i < box_colliders.size(); i++ )
    {
        filter_collider( box_colliders[i] );
    }
    for ( uint32_t i = 0; i < plane_sdfs.size(); i++ )
    {
        filter_collider( plane_sdfs[i] );
    }
    for ( uint32_t i = 0; i < sphere_sdfs.size(); i++ )
    {
        filter_collider( sphere_sdfs[i] );
    }
    for ( uint32_t i = 0; i < line_sdfs.size(); i++ )
    {
        filter_collider( line_sdfs[i] );
    }
    for ( uint32_t i = 0; i < box_sdfs.size(); i++ )
    {
        filter_collider( box_sdfs[i] );
    }
