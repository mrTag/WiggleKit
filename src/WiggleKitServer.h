...
public:
	...
	uint32_t plane_sdf_create(const Vector3 &p_position, const Vector3 &p_normal, float p_rest_distance, float p_compliance);
	...
	uint32_t sphere_sdf_create(const Vector3 &p_position, float p_radius, float p_rest_distance, float p_compliance);
	...
	uint32_t line_sdf_create(const Vector3 &p_position_a, const Vector3 &p_position_b, float p_rest_distance, float p_compliance, bool p_infinite = true);
	...
	uint32_t box_sdf_create(const Vector3 &p_position, const Basis &p_basis, const Vector3 &p_size, float p_rest_distance, float p_compliance);
